...
?>
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group" style="display:none;">
                        <label>Item name</label>
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="total_item" value="<?php echo $value['total_item']; ?>">
                      </div>

                      <div class="form-group">
                        <label>Unit Price</label>
                        <input type="text" name="unit_price" class="form-control form-control-user" id="exampleInputPassword" value="<?php echo $value['unit_price']; ?>">
                      </div>
