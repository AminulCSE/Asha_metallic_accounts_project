...
<?php
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $unit_price             = $fm->validation($unit_price);
    ...
    $unit_price             = mysqli_real_escape_string($db->link, $unit_price);
    ...
    $total_price = $total_item*$unit_price;
    ...
    if (empty($item_name)||empty($item_description)||empty($unit_price)||empty($bill_no)||empty($client_name)) {
    ...
    if (!empty($file_name)) {
        ...
        $query = "INSERT INTO tbl_bill(image,item_name,total_item,item_description,unit_price,total_price,paid_amount,bill_no,client_name,client_phone,institute_name) 
        VALUES('$uploaded_image', '$item_name', '$total_item', '$item_description','$unit_price' '$total_price','$paid_amount', '$bill_no','$client_name', '$client_phone', '$input_institute_name')";
      ...
      $query = "INSERT INTO tbl_bill(item_name, total_item, item_description,unit_price,total_price,paid_amount,bill_no,client_name,client_phone,institute_name) 
        VALUES('$item_name', '$total_item', '$item_description','$unit_price', '$total_price','$paid_amount', '$bill_no','$client_name', '$client_phone', '$input_institute_name')";
        $inserted_rows = $db->insert($query);
        if ($inserted_rows) {
         echo "<span class='success'>Inserted Successfully.
         </span>";
...
?>
                  <form class="user" action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="unit_price" class="form-control form-control-user" id="exampleInputPassword" placeholder="Amount per item Price....">
                      </div>
